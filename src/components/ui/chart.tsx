...
const ChartContainer = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    config: ChartConfig,
    /** Pass only ONE of: aspect OR height */
    aspect?: number,
    height?: number | string,
    width?: number | string,
    /** Directly pass your <AreaChart/BarChart/...> as children (no nested ResponsiveContainer) */
    children: React.ComponentProps<typeof RechartsPrimitive.ResponsiveContainer>["children"]
  }
>(({ id, className, children, config, aspect = 1.6, height, width = "100%", ...props }, ref) => {
